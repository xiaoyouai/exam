                                    ...
                                    if (err3) {
                                        ...
                                        if (doc3) {
                                            ...
                                            doc3.forEach(item => {
                                                sum++;
                                                studentQuestion = [];
                                                item._questions.forEach(data => {
                                                    studentQuestion.push({ "_question": data, answer: '' })
                                                })
                                                Student.updateMany({ //学生直接更新整个题目数组,把数据换成试卷的题目
                                                    "class": item.examclass,
                                                    "exams._paper": item._id
